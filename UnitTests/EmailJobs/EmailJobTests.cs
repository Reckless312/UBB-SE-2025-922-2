...
//        {
//            new User { UserId = new Guid(), EmailAddress = "user@example.com", Username = fullName, NumberOfDeletedReviews = numberOfDeletedReviews, AssignedRoles = assignedRoles, PasswordHash = String.Empty, TwoFASecret = String.Empty }            new User(new Guid(), "admin2@example.com", "Second Admin", 0, false, UserRepository.AdminRoles),
//            new User(new Guid(), "user@example.com", "Regular User", 0, false, UserRepository.BasicUserRoles),
//            new User(new Guid(), "user2@example.com", "Another User", 1, false, UserRepository.BasicUserRoles),
//            new User(new Guid(), "banned@example.com", "Banned User", 3, true, UserRepository.BannedUserRoles),
//        };
